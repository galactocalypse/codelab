...
public final class CodelabTopicRegistry {
    ...
    /**
     * Call this once per candidate during the registrar pass, BEFORE registering
     * its bean definition. Throws on any second interface claiming the same
     * physical topic, whether that's a copy-paste bug within one module or two
     * modules accidentally colliding.
     */
